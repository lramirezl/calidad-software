    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addContainerGap())
            .addComponent(p5, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 874, Short.MAX_VALUE)
        );
...
public void exportTable(JTable table, File file) throws IOException
 {
    ...
    public String segunLoscampos(int a, int b, int c, int d) {
        String sql = null;
       if (a == 1 && b == 1 && c == 1 && d == 1) {
                  sql = "select codigo, ruc,razon_social, telefono, direccion,email, categoria from proveedor "
                    + "where"
                    + " codigo  like '%" + p1 + "%'"
   ...
   System.out.print(sql);
    ...
    void mostrarTabla(){
        vClie = objGBD.vectorConsulta("select codigo, ruc,razon_social, telefono, direccion,email, categoria from proveedor  ");
        DefaultTableModel model = new DefaultTableModel(vClie, colNames);
        TABLA1.setModel(model);
        //agrandar el ancho de las fila
        TABLA1.setRowHeight(18);
