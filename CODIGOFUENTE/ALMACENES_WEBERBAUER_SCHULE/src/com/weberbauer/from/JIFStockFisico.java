 ...
 * JIFProveedores.java
 *
 * Created on 08-jul-2010, 22:27:07
 */
 ...
 * @author arnold
 */
public class JIFStockFisico extends javax.swing.JInternalFrame {
//imprimir_pagina
    ...
    private void initComponents() {
        ...
        L02.setText("Cantidad de Familias");
...
public void exportTable(JTable table, File file) throws IOException
 {
    ...
    public String segunLoscampos(int a, int b, int c, int d) {
        String sql = null;
       if (a == 1 && b == 1 && c == 1 && d == 1) {
                  sql = "select familia,codigo_producto, descripcion, unidad_medida, cantidad from Stock "
                    + "where"
                    + " familia  like '%" + p1 + "%'"
...
System.out.print(sql);
    ...
    void mostrarTabla(){
        vClie = objGBD.vectorConsulta("select familia,codigo_producto, descripcion, unidad_medida, cantidad from Stock ");
        DefaultTableModel model = new DefaultTableModel(vClie, colNames);
        TABLA1.setModel(model);
       // jTable1.getColumnModel().getColumn(0).setMaxWidth(1500);
       TABLA1.getColumnModel().getColumn(0).setMinWidth(150); //faamilia
