...
public class ProveedorGeneral extends javax.swing.JFrame {
   ...
   void mostrarTabla()
   {
        vClie = objGBD.vectorTabla(" proveedor_general order by len(codigo),codigo");
    ...
    private void initComponents() {
        ...
        jLabel13.setText("PROVEEDORES GENERALES");
  ...
  else
  {
      ...
      if(N==1)
      {
          if(cantidad == 0)
          {
          String sql="insert into proveedor_general values('"+
       ...
       {
       String sql="update proveedor_general set " +
       "ruc='"+txtRuc.getText()+"', " +
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if(eliminar==0)
        {
            ...
            String sql = "delete from proveedor_general where codigo='"+cod+"' and ruc='"+ruc+"' and " +
 ...
 mostrarTabla();
    ...
    public int CantidadCodigo(String codigoproveedor){
        int StoActual = 0;
        String sql="select count(codigo) from proveedor_general where codigo='"+codigoproveedor+"'";
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProveedorGeneral().setVisible(true);
            }
        });
    }
