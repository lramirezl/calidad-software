...
import com.weberbauer.from.Entrada;
 import java.util.*;
 import java.awt.*;
...
public class calendarioEntrada extends JDialog{
 ...
 private Entrada owner; //frame entradas
 private JLabel dias[][];
 ...
 private int ano;        //Año actual
   ...
   public calendarioEntrada(Entrada owner) {
