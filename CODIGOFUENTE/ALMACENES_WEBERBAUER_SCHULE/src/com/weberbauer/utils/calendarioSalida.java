...
import com.weberbauer.from.Salidas;
 import java.util.*;
 import java.awt.*;
...
public class calendarioSalida extends JDialog{
 ...
 private Salidas owner; //frame entradas
 private JLabel dias[][];
 ...
 private int ano;        //Año actual
   ...
   public calendarioSalida(Salidas owner) {
